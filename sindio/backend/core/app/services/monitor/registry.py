...
POWER = _register(InfraConfig(
    ...
    data_sources=[
        InfraDataSource(
            ...
            query="SELECT bus_id, voltage_pu, load_mw FROM power_scada WHERE updated_at > NOW() - INTERVAL '14 days'",
            fallback_query="SELECT bus_id, voltage_pu, load_mw FROM power_scada WHERE updated_at > NOW() - INTERVAL '30 days'",
            data_type="telemetry", freshness_threshold_sec=1209600,
        ),
        InfraDataSource(
...
WATER = _register(InfraConfig(
    ...
    data_sources=[
        InfraDataSource(
            ...
            query="SELECT node_id, pressure_m, flow_lps FROM water_scada WHERE updated_at > NOW() - INTERVAL '14 days'",
...
ROADS = _register(InfraConfig(
    ...
    data_sources=[
        InfraDataSource(
            ...
            query="SELECT h3_index, vehicle_count FROM mobility_aggregates WHERE time > NOW() - INTERVAL '14 days'",
...
SOLID_WASTE = _register(InfraConfig(
    ...
    data_sources=[
        InfraDataSource(
            ...
            query="SELECT station_id, fill_level FROM waste_sensors WHERE updated_at > NOW() - INTERVAL '14 days'",
...
SIDEWALKS = _register(InfraConfig(
    ...
    data_sources=[
        InfraDataSource(
            ...
            query="SELECT path_id, pedestrian_count FROM sidewalk_counters WHERE updated_at > NOW() - INTERVAL '14 days'",
...
LRT = _register(InfraConfig(
    ...
    data_sources=[
        InfraDataSource(
            ...
            query="SELECT segment_id, train_count, headway_sec FROM lrt_telemetry WHERE updated_at > NOW() - INTERVAL '14 days'",
...
SGR = _register(InfraConfig(
    ...
    data_sources=[
        InfraDataSource(
            ...
            query="SELECT segment_id, stress_level, speed_limit FROM sgr_telemetry WHERE updated_at > NOW() - INTERVAL '14 days'",
...
AIRPORTS = _register(InfraConfig(
    ...
    data_sources=[
        InfraDataSource(
            ...
            query="SELECT runway_id, flight_rate, surface_condition FROM airport_telemetry WHERE updated_at > NOW() - INTERVAL '14 days'",
